...
export class OpenCellsExpandableMultistepIndex extends WidgetMixin(ScopedElementsMixin(LitElement)) {
  ...
  static get defaultLocale() {
    return { label: "Expandable Multistep Index", action: 'Continue' };
  }
