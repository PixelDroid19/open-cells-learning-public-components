...
export class OpenCellsDataVisualizationLinear extends WidgetMixin(ScopedElementsMixin(LitElement)) {
  ...
  static get defaultLocale() {
    return { label: "Data Visualization Linear", action: 'Continue' };
  }
