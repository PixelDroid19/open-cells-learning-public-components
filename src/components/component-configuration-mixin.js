...
export class OpenCellsComponentConfigurationMixin extends WidgetMixin(ScopedElementsMixin(LitElement)) {
  ...
  static get defaultLocale() {
    return { label: "Component Configuration Mixin", action: 'Continue' };
  }
