...
export class OpenCellsWidgetConfigurationMixin extends WidgetMixin(ScopedElementsMixin(LitElement)) {
  ...
  static get defaultLocale() {
    return { label: "Widget Configuration Mixin", action: 'Continue' };
  }
